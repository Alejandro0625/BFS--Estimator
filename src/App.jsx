      ...
      <div style={{flex:1,overflow:"auto",display:"flex",flexDirection:"column",alignItems:"center",padding:"1rem",gap:"0.75rem"}}>
        ...
        <div style={{alignSelf:"stretch",display:"flex",alignItems:"center",gap:"0.5rem",flexWrap:"wrap"}}>
          ...
          {/* CROSS-PAGE SCALE-OUTLIER review flag (backend scaleOutlier/scaleOutlierNote): this
              ...
              SF by scale², so point her at Calibrate. Renders nothing when the flag is absent. */}
          {elev?.scaleOutlier&&<div onClick={()=>{setCalibMode(true);setCalibPts([]);}} title={elev?.scaleOutlierNote||"This page's scale differs from the rest of this set — verify or calibrate before trusting its SF."} style={{display:"flex",alignItems:"center",gap:"0.3rem",fontSize:"0.62rem",fontWeight:700,color:"#FCA5A5",padding:"0.3rem 0.7rem",borderRadius:20,background:"#7F1D1D",border:"1px solid #B91C1C",cursor:"pointer"}}>⚠ scale looks off vs this set — calibrate</div>}
